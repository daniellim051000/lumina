...
from api.task.models import Label, Task, TaskComment
...
class TaskAPITest(BaseTaskAPITest):
    ...
    def test_filter_today_tasks(self):
        ...
        completed_today_task = TaskFactory(
            user=self.user, date=today, is_completed=True
        )
    ...
    def test_filter_overdue_tasks(self):
        ...
        completed_overdue_task = TaskFactory(
            user=self.user, due_date=yesterday, is_completed=True
        )
